// Utility function to safely normalize any input to a lowercase string
...
// Example: Safely rendering a checkbox tick based on condition string
// export const renderCheckboxTick = (condition) => {
//   if (condition === true) return true; // actual boolean true
//   if (condition === false || condition == null) return false; // false, null, or undefined

//   const value = normalizeString(condition);

//   return ["yes", "true", "checked"].includes(value);
// };

export const isTruthyValue = (value) =>
  ["yes", "true", "checked"].includes(normalizeString(value)) || value === true;
...
export const ageGaps = [15, 51, 15, 33];

export const truncateToGaps = (text, maxLength) => {
...
export const dobGaps = [
  ...
  18, // between second M and first Y
  14, // between Y and Y
