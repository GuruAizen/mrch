import page2 from "@/assets/form_templates/star_health/star_health_page_2.jpg";
...
const StarHealthPage2 = ({ data }) => {
  ...
  return (
     <PageContainer>
        ...
        {/********************************** CONTACT NUMBER ****************************/}
        {renderParagraph(data?.contactNo || " - ", 193, 442, 253, 22)}
        {/********************************** NATURE OF ILLNESS ****************************/}
        {renderParagraph(
        ...
        {renderParagraph(
          getValidFormattedDate(data?.doctorDateOfFirstConsultation) || " - ",
          326,
          442,
          123,
          22
        ...
        {/* <EraseArea top={496} left={144} width={241} height={28} /> */}
        ...
        {/********************************** ROUTE OF DRUG ADMINISTARTION ****************************/}

        {renderParagraph(
          safeUpper(data?.routeOfDrugAdministration || ""), // show full value
          625,
          503,
          190,
          20
        ...
        {/* <EraseArea top={537} left={143} width={244} height={24} /> */}

        {renderParagraph(data?.surgicalNameOfSurgery || "", 663, 293, 192, 18)}

        {/********************************** ICD 10 PCS CODE ****************************/}

        {renderParagraph(data?.icd10PcsCode || " - ", 673, 503, 192, 22)}
        ...
        {renderParagraph(data?.howDidInjuryOccur || "", 744, 442, 255, 22)}

        {/********************************** IN CASE OF ACCIDENT ****************************/}
        {normalizeString(data?.isItRta) === "no" && (
          <Tick top={824} left={566}>
            ✔
          </Tick>
        )}
        {normalizeString(data?.isItRta) === "no" && (
          <Tick top={824} left={659}>
            ✔
          </Tick>
        )}
        {/********************************** DATE OF INJURY ****************************/}
        ...
        {normalizeString(data?.reportedToPolice) === "yes" && (
          <Tick top={860} left={565}>
            ✔
          </Tick>
        )}
        {normalizeString(data?.reportedToPolice) === "no" && (
          <Tick top={860} left={660}>
            ✔
          </Tick>
        )}
...
export default StarHealthPage2;
