import page3 from "@/assets/form_templates/star_health/star_health_page_3.jpg";
  ...
  return (
     <PageContainer>
        ...
        {isEmergencyType("an emergency") && (
          <Tick top={272} left={505}>
            ✔
          </Tick>
        )}
        {isEmergencyType("a planned hospitalization event") && (
          <Tick top={272} left={621}>
            ✔
          </Tick>
        )}
        {/********************************** MANDATORY PAST HISTORY ****************************/}

        {/********************************** DIABETES ****************************/}
        {renderParagraph(
          normalizeString(data?.diabetesSinceTf) === "true"
            ? data?.diabetesSince || "-"
            : "-",
          322,
          427,
        ...
        {/********************************** HEART DISEASE ****************************/}
        {renderParagraph(
          normalizeString(data?.heartDiseaseSinceTf) === "true"
        ...
        {/********************************** HYPERTION ****************************/}
        {renderParagraph(
          normalizeString(data?.hypertensionSinceTf) === "true"
        ...
        {/********************************** OSTEOARTHRITIS ****************************/}
        {renderParagraph(
          normalizeString(data?.osteoarthritisSinceTf) === "true"
        ...
        {renderParagraph(
          normalizeString(data?.asthmaCopdBronchitisSinceTf) === "true"
        ...
        {/********************************** CANCER ****************************/}
        {renderParagraph(
          normalizeString(data?.cancerSinceTf) === "true"
            ? data?.cancerSince || "-"
            : "-",
          410,
          427,
        ...
        {/********************************** ALCOHOL / DRUG ABUSE ****************************/}
        {renderParagraph(
          normalizeString(data?.alcoholDrugabuseSinceTf) === "true"
        ...
        {/********************************** HIV ****************************/}
        {renderParagraph(
          normalizeString(data?.hivstdSinceTf) === "true"
            ? data?.hivstdSince || "-"
            : "-",
          444,
          427,
        ...
        {renderParagraph(
          normalizeString(data?.rheumatoidArthritisSinceTf) === "true"
            ? data?.rheumatoidArthritisSince || "-"
            : "-",
          461,
          427,
          80,
        ...
        {renderParagraph(
          normalizeString(data?.rheumatoidArthritisSinceTf) === "true"
            ? data?.rheumatoidArthritisRemarks || "-"
            : "-",
          461,
          510,
          185,
        ...
        {/********************************** CEREBRO VASCULAR ****************************/}
        {renderParagraph(
          normalizeString(data?.cerebroVascularSinceTf) === "true"
            ? data?.cerebroVascularSince || "-"
            : "-",
          478,
          427,
          80,
        ...
        {/********************************** LIVER ****************************/}
        {renderParagraph(
          normalizeString(data?.liverDiseaseSinceTf) === "true"
            ? data?.liverDiseaseSince || "-"
            : "-",
          496,
          427,
          80,
        ...
        {/********************************** KIDNEY ****************************/}
        {renderParagraph(
          normalizeString(data?.kidneyDiseaseSinceTf) === "true"
            ? data?.kidneyDiseaseSince || "-"
            : "-",
          512,
          427,
          80,
        ...
        {renderParagraph(
          normalizeString(data?.anyOtherailmentSinceTf) === "true"
        ...
        {renderParagraph(data?.gradeOfSurgery || "", 611, 349, 186, 22)}

        {/********************************** DAYS IN ICU ****************************/}
        {renderParagraph(data?.daysInIcu || "", 643, 349, 146, 22)}

        {/********************************** ROOM TYPE ****************************/}
        {renderParagraph(data?.roomType || "", 677, 350, 346, 22)}
        ...
        {/********************************** ICU CHARGES ****************************/}
        {renderParagraph(data?.icuCharges || "", 782, 211, 484, 22)}

        {/********************************** OT CHARGES ****************************/}
        {renderParagraph(data?.otCharges || "", 817, 204, 489, 22)}
...
export default StarHealthPage3;
