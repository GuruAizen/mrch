import page6 from "@/assets/form_templates/star_health/star_health_page_6.jpg";
  ...
  return (
     <PageContainer>
          <PageWrapper pageBreak={true}>
            <BackgroundImage src={page6.src} alt="Background Form" />
        {/*******************************DATE AND TIME *****************************/}
        {renderParagraph(
        ...
        {renderImage(
          ...
          590, // top (pixels from top)
          150, // left (pixels from left)
          120, // width in px
          40, // height in px
...
export default StarHealthPage6;
