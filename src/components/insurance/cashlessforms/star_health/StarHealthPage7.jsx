import page7 from "@/assets/form_templates/star_health/star_health_page_7.jpg";
  ...
  return (
    <PageContainer>
      <PageWrapper pageBreak={true}>
        <BackgroundImage src={page7.src} alt="Background Form" />
      </PageWrapper>
    </PageContainer>
  );
};

export default StarHealthPage7;
